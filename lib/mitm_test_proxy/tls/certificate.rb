...
module MitmTestProxy
  ...
  class Certificate
    include MitmTestProxy::CertificateHelpers
    ...
    # Example:
    #
    #   cert = MitmTestProxy::Certificate.new('localhost')
    ...
    def generate
      ...
      configure(cert)
      add_extensions(cert)
      cert.sign(::MitmTestProxy.certificate_authority.key, OpenSSL::Digest::SHA256.new)
    end
    ...
    def configure(cert)
      req = signing_request
      cert.issuer = ::MitmTestProxy.certificate_authority.cert.subject
    ...
    def add_extensions(cert)
      ...
      factory.issuer_certificate = ::MitmTestProxy.certificate_authority.cert
